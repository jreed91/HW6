...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
    <asp:GridView ID="GridView1" GridLines="None" runat="server" CssClass="table table-hover" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="RecordID" DataSourceID="SqlDataSource1">
    <Columns>
